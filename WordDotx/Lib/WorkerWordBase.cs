...
namespace WordDotx.Lib
{
    ...
    /// </summary>
    public abstract class WorkerWordBase : TaskWordBase.FarmWordDotxBase.WorkerBaseInclude
    {
        ...
        /// </summary>
        protected event EventHandler<EvWorkerWordBaseError> onEvWorkerBaseError;
        ...
        private void Run()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    EvWorkerWordBaseError ArgErrorW = new EvWorkerWordBaseError(this, ex.Message);
        ...
        /// </summary>
        public abstract class WorkerWordListBase : IEnumerable
        {
            /// <summary>
            /// Внутренний список 
            /// </summary>
            private List<WorkerWordBase> WrkL = new List<WorkerWordBase>();
            ...
            protected bool Add(WorkerWordBase newWrk, bool HashExeption)
            {
                bool rez = false;
            ...
            /// <param name="HashExeption">C отображением исключений</param>
            /// <returns>Результат операции (Успех или нет)</returns>
            protected bool Remove(WorkerWordBase delWrk, bool HashExeption)
            {
                bool rez = false;
                try
                {
            ...
            public WorkerWordBase this[int i]
            {
                get
                {
                    try
                    {
                        WorkerWordBase rez = null;
                        lock (WrkL)
                        {
                            rez = this.WrkL[i];
                        }
